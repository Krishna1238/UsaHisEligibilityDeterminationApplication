...
/**
 * <p>Java class for CitigenData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CitigenData">
 *   &lt;complexContent>
...
@XmlType(name = "CitigenData", propOrder = {
    "firstName",
    "lastName",
    "gender",
    "caseNum",
...
public class CitigenData {
	...
	public String toString() {
		return "CitigenData [firstName=" + firstName + ", lastName=" + lastName + ", gender=" + gender + ", caseNum="
				+ caseNum + ", ssn=" + ssn + ", dob=" + dob + ", planSelected=" + planSelected + "]";
	}
